...
Histogram LBPMatcher::createLBPHistogram(int **lbpMatrix, l_int32 cols, l_int32 rows, l_int32 _x, l_int32 _y, l_int32 w, l_int32 h)
{
    static int counter = 0;
    counter++;
